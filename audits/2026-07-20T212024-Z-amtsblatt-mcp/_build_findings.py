...
FINDINGS = {
    "SDK-001": dict(sev="high", title="FastMCP Lifespan + shared HTTP client", status="closed — remediated 2026-07-20", effort="M",
    ...
    "SEC-016": dict(sev="critical", title="0.0.0.0 binding prevention (NeighborJack)", status="closed — remediated 2026-07-20", effort="S",
    ...
    "SCALE-006": dict(sev="medium", title="Per-container resource limits", status="closed — remediated 2026-07-20", effort="S",
    ...
    "ARCH-008": dict(sev="medium", title="Three primitives: Tools, Resources, Prompts", status="accepted-risk", effort="M",
    ...
    "ARCH-012": dict(sev="medium", title="protocolVersion pinning", status="accepted-risk", effort="S",
    ...
    "SDK-002": dict(sev="medium", title="Structured tool return types", status="accepted-risk", effort="M",
    ...
    "SDK-003": dict(sev="medium", title="Context injection for progress/logging", status="accepted-risk", effort="M",
