...
Nicht zu verwechseln mit `tests/fixtures.py`: das sind die gekuerzten,
anonymisierten Stubs fuer die Fehlerpfade und die gesperrten Rubriken. Beides
hat seinen Platz — was der Server nie abholt, laesst sich auch nicht
aufzeichnen.
