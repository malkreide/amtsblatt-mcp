...
> session-bearing SSE transport this server serves. It stops applying the day
> that transport is dropped — tracked in `ROADMAP.md`, now on the spec's
> twelve-month deprecation clock rather than on a preference.
